...
namespace PosGreSql.WebAPI
{
    ...
    {
        public ApplicationUserStore(PosGreSqlDbContext context)
            : base(context)
        {
        }
    }
    ...
    public class ApplicationRoleManager : RoleManager<AppRole>
    {
        ...
        {
            return new ApplicationRoleManager(new RoleStore<AppRole>(context.Get<PosGreSqlDbContext>()));
        }
    }
    ...
    public class ApplicationUserManager : UserManager<AppUser>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<AppUser>(context.Get<PosGreSqlDbContext>()));
